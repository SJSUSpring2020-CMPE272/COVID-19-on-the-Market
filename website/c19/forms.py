...
class FieldsForm(forms.Form):
        ...
        t1 = forms.CharField(widget=forms.NumberInput(attrs={'id': 't1_range','type':'range', 'value': '1.7', 'step': '.01', 'min': '1.00', 'max': '100.00'}), required=False)
        conf1 = forms.CharField(widget=forms.NumberInput(attrs={'id': 'conf1_range','type':'range','value': '1000', 'step': '1', 'min': '1', 'max': '1000000'}), required=False)
        rec1 = forms.CharField(widget=forms.NumberInput(attrs={'id': 'rec1_range','type':'range', 'value': '200','step': '1', 'min': '1', 'max': '1000000'}), required=False)
        dth1 = forms.CharField(widget=forms.NumberInput(attrs={'id': 'dth1_range','type':'range', 'value': '50','step': '1', 'min': '1', 'max': '1000000'}), required=False)
        un1 = forms.CharField(widget=forms.NumberInput(attrs={'id': 'un1_range','type':'range','value': '220100.0', 'step': '.01', 'min': '1', 'max': '1000000.0'}), required=False)
        gas1 = forms.CharField(widget=forms.NumberInput(attrs={'id': 'gas1_range','type':'range', 'value': '2.329','step': '.001', 'min': '1', 'max': '25.000'}), required=False)
        dies1 = forms.CharField(widget=forms.NumberInput(attrs={'id': 'dies1_range','type':'range', 'value': '3.013','step': '.001', 'min': '1', 'max': '25.000'}), required=False)
